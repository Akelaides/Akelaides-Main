...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(('Accolade V1.2.3 | %s fps | %s ms / By Calvin'):format(
        math.floor(FPS),
...
CollarPlayerGroup:AddToggle('CollarPlayer', {
    Text = 'Enabled',
    Default = false,
    Tooltip = "Collar's the player making them look like your pet black nigger ",
    Callback = function(Value)
        CollarPlayer = Value
    end
})
...
CreditsGroup:AddLabel('Made by Calvin Sigma')
CreditsGroup:AddLabel('Made with love and tits :3')
